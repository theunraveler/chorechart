...
describe ChoresController do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Chore" do
        expect {
          post :create, :chore => valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested chore" do
        ...
        Chore.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => chore.id, :chore => {'these' => 'params'}
      end

      it "assigns the requested chore as @chore" do
        chore = Chore.create! valid_attributes
        put :update, :id => chore.id, :chore => valid_attributes
        assigns(:chore).should eq(chore)
      end
    ...
    describe "with invalid params" do
      it "assigns the chore as @chore" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Chore.any_instance.stub(:save).and_return(false)
        put :update, :id => chore.id.to_s, :chore => {}
        assigns(:chore).should eq(chore)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested chore" do
      chore = Chore.create! valid_attributes
      expect {
        delete :destroy, :id => chore.id.to_s
      }.to change(Chore, :count).by(-1)
    end
